module simqo.com/mygospace/learngo/example/go-micro
...
require (
	...
	github.com/micro/go-plugins v2.0.1-0.20200513114939-389611c31773+incompatible // indirect
	...
	k8s.io/apimachinery v0.0.0-20191111054156-6eb29fdf75dc // indirect
