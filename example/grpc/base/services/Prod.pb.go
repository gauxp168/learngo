...
func (x *ProdRequset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProdRequset) ProtoMessage() {}

func (x *ProdRequset) ProtoReflect() protoreflect.Message {
	mi := &file_Prod_proto_msgTypes[0]
...
// Deprecated: Use ProdRequset.ProtoReflect.Descriptor instead.
func (*ProdRequset) Descriptor() ([]byte, []int) {
	return file_Prod_proto_rawDescGZIP(), []int{0}
}

func (x *ProdRequset) GetProdId() int32 {
	if x != nil {
		return x.ProdId
	}
	return 0
...
var file_Prod_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x26, 0x0a, 0x0b,
	0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x71, 0x75, 0x73, 0x65, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x70,
	...
	0x63, 0x6b, 0x12, 0x0c, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x71, 0x75, 0x73, 0x65, 0x74,
...
var file_Prod_proto_goTypes = []interface{}{
	(*ProdRequset)(nil),  // 0: ProdRequset
	(*ProdResponse)(nil), // 1: ProdResponse
}
var file_Prod_proto_depIdxs = []int32{
	0, // 0: ProdService.GetProdStock:input_type -> ProdRequset
...
type ProdServiceClient interface {
	GetProdStock(ctx context.Context, in *ProdRequset, opts ...grpc.CallOption) (*ProdResponse, error)
}
...
func (c *prodServiceClient) GetProdStock(ctx context.Context, in *ProdRequset, opts ...grpc.CallOption) (*ProdResponse, error) {
...
type ProdServiceServer interface {
	GetProdStock(context.Context, *ProdRequset) (*ProdResponse, error)
}
...
func (*UnimplementedProdServiceServer) GetProdStock(context.Context, *ProdRequset) (*ProdResponse, error) {
...
func _ProdService_GetProdStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProdServiceServer).GetProdStock(ctx, req.(*ProdRequset))
	}
